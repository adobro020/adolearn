    ...
    <header className="rounded-b-[2rem] bg-white/90 px-5 pb-6 pt-5 shadow-sm shadow-slate-200/80 ring-1 ring-white/70 backdrop-blur transition-colors md:rounded-[2rem] md:px-8 md:py-7 dark:bg-black dark:shadow-none dark:ring-zinc-700">
      <div className="mx-auto flex max-w-5xl flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div className="flex items-center gap-4">
          <div className="grid h-16 w-16 place-items-center overflow-hidden rounded-[1.35rem] bg-emerald-100 ring-2 ring-emerald-200 motion-safe:animate-bounce-soft" aria-hidden="true">
            <img src={ROBOT_GRAPHICS.head} alt="" className="h-16 w-16 object-cover" />
          </div>
          <div>
