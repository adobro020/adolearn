export function Header() {
  return (
    <header className="rounded-b-[2rem] bg-white/85 px-5 pb-6 pt-5 shadow-sm shadow-slate-200/80 ring-1 ring-white/70 backdrop-blur transition-colors md:rounded-[2rem] md:px-8 md:py-7">
